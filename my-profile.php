...
$query="update  userRegistration set regNo=?,firstName=?,middleName=?,lastName=?,email=?,contactNo=?,updationDate=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssisi',$regno,$fname,$mname,$lname,$email,$contactno,$udate,$aid);
$stmt->execute();
...
<div class="col-sm-8">
<input type="text" name="gender" class="form-control" value="<?php echo $row->gender;?>" required="required" readonly>
<!--<option value="</option>
